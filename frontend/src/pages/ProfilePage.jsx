              ...
              {isEditingName ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-zinc-600 rounded-lg text-white hover:bg-zinc-700"
                    disabled={isUpdatingProfile}
                  >
                    Cancel
                  </button>
                ...
                <div
                  className="px-4 py-2.5 bg-base-200 rounded-lg border cursor-pointer hover:bg-base-100 transition"
